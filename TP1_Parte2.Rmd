...
Las ocurrencias de $X=0$ en la distribución se aproximan a $8000$, y las de $X=1$ a $2000$, las cuales corresponden con la probabilidad $p=0,2$ y la cantidad de repeticiones $Nrep = 10000$. Es consistente ya que con un valor de n grande, $P(|θn − θ| > ϵ) → 0 ∀ϵ > 0$
...
En los graficos se puede observar que a medida que el valor de n es mas alto, los promedios se concentran mas cerca de la esperanza de la variable que estamos analizando. Esto se explica por la Ley de los Grandes Numeros.
...
Cuanto mayor sea la n, mas se aproxima a la esperanza
